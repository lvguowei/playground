...
(defn row-positions
  "Return all positions in the given rows"
  [row-num]
...
(defn prompt-move
  ...
  (prn "\nHere is your board:")
  (print-board board)
  (prn "Move from where to where? Enter two letters:")
...
(defn game-over
  ...
  (let [remaining-pegs (count (filter :pegged (vals board)))]
    (prn "Game over! You had" remaining-pegs "pegs left:")
    (print-board board)
    (prn "Play again? y/n [y]")
...
(defn prompt-empty-peg
  [board]
  (prn "Here's your board:")
  (print-board board)
  (prn "Remove which peg? [e]")
